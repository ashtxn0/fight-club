...
window.onclick = function (event) {
  if (!event.target.matches(".user-drop-content") && !event.target.matches(".drop-down-img") && !event.target.matches(".user-drop-content > *") && !event.target.matches(".dark-theme-container *")) {
