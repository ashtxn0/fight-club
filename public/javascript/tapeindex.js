...
function showTape(i){
    ...
    if (isOpen===0){
        ...
        $(".slide-out-fighter").append("<div class='fight-index-fighter-info-col'> <div class='tape-index-fighter-img-container'> <img class='tape-index-fighter-img-lg' src='"+fighters[i].image_url+"' alt='event picture'> <div class='background-gradient'></div> <div class='tape-index-fighter-title'> <h3>"+fighters[i].name+"</h3> <p>("+fighters[i].wins.total+"-"+fighters[i].losses.total+")</p> </div> </div> <div class='tape-index-fighter-info'> <p>Age: "+fighters[i].age+"</p> <p>Height: "+fighters[i].height+"</p> <p>Weight: "+fighters[i].weight+"</p> <p class='fight-win'>wins via: ("+fighters[i].wins.knockouts+" KO - "+fighters[i].wins.submissions+" SUB - "+fighters[i].wins.decisions+" DEC)</p> <p class='fight-loss'>losses via: ("+fighters[i].losses.knockouts+" KO - "+fighters[i].losses.submissions+" SUB - "+fighters[i].losses.decisions+" DEC)</p> </div> </div> <h3>Fight Links:</h3> <div class='tape-index-fights slide-out-fighter-fights'> </div>");
        $(".slide-out-opponent").append("<div class='fight-index-fighter-info-col'> <div class='tape-index-fighter-img-container'> <img class='tape-index-fighter-img-lg' src='"+opponents[i].image_url+"' alt='event picture'> <div class='background-gradient'></div> <div class='tape-index-fighter-title'> <h3>"+opponents[i].name+"</h3> <p>("+opponents[i].wins.total+"-"+opponents[i].losses.total+")</p> </div> </div> <div class='tape-index-fighter-info'> <p>Age: "+opponents[i].age+"</p> <p>Height: "+opponents[i].height+"</p> <p>Weight: "+opponents[i].weight+"</p> <p class='fight-win'>wins via: ("+opponents[i].wins.knockouts+" KO - "+opponents[i].wins.submissions+" SUB - "+opponents[i].wins.decisions+" DEC)</p> <p class='fight-loss'>losses via: ("+opponents[i].losses.knockouts+" KO - "+opponents[i].losses.submissions+" SUB - "+opponents[i].losses.decisions+" DEC)</p> </div> </div> <h3 style='visibility: hidden;'>Fight Links:</h3> <div class='tape-index-fights slide-out-opponent-fights'> </div>");

        fighters[i].fights.forEach(function(fight){
            $(".slide-out-fighter-fights").append("<div class='tape-index-fight-row'> <div class='tape-index-fight-outcome fight-"+fight.result+"'> <h3>"+fight.result+"</h3> </div> <div class='tape-index-fight-info'><a target='_blank' href='/fighter/"+fighters[i].name+"'><h3>"+fighters[i].name+"</h3></a> <a target='_blank' href='/fighter/"+fight.opponent+"'><h3>vs. "+fight.opponent+"</h3></a> <p>"+fight.method+"</p> </div> </div>");
        })
        opponents[i].fights.forEach(function(fight){
            $(".slide-out-opponent-fights").append("<div class='tape-index-fight-row'> <div class='tape-index-fight-outcome fight-"+fight.result+"'> <h3>"+fight.result+"</h3> </div> <div class='tape-index-fight-info'> <a target='_blank' href='/fighter/"+fight.opponent+"'><h3>vs. "+fight.opponent+"</h3></a> <p>"+fight.method+"</p> </div> </div>");
        })
